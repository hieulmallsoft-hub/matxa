...
describe('Marketplace HTTP validation and optional authentication', () => {
  ...
  it.each(['available=garbage', 'available=1', 'gender=bad', 'mode=bad', 'categoryId=bad', 'serviceId=bad', 'page=0', 'limit=101', 'tags=', 'latitude=NaN', 'latitude=91&longitude=0', 'longitude=181'])('rejects invalid query %s', async (query) => {
